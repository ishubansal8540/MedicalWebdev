...
$sno=$_GET['sno'];
$query="select * from diseases where sno='$sno'";
...
while($c=mysqli_fetch_array($res))
		...
		?>				
								<div class="item item2">
									<div class="pic">
							<img src="<?php echo 'admin/diseases_images/'.$c[5];?>" alt="<?php echo $c[3];?>" id="img1">
		...
		-				<!-- details -->
						...
						<div class="widget-title"></div>
							...
							<?php echo $c['sub_category']."<br>";?>
							<?php echo $c['diseases_name']."<br>";?>
						    <?php echo $c['detail']."<br>";?>
							<?php echo $c['symptoms']."<br>";?>
							<?php echo $c['causes']."<br>";?>
							<?php echo $c['prevention']."<br>";?>
							<?php echo $c['medicine']."<br>";?>
...
<div style="posiiton:relative;top:-230px">
			<?php
			include("footer.php");
			?>
			</div>
