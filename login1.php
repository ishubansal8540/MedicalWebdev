...
$x="Select * from users where email='$user' and password='$pass'";
...
if(isset($_POST['ch']))
{
setcookie("email","$user",time()+4*24*3600);
...
{
	echo"<script>alert('Wrong username and password');</script>".mysqli_error($connect);
}
}
}
