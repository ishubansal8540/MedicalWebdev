            ...
            <div class="sidebar-nav">
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        ...
                        <li><a class="ajax-link" href="insert_notice.php" target="php"><i class="glyphicon glyphicon-eye-open"></i><span>Notice</span></a>
                        </li>
        ...
        <div class="box-inner">
            ...
            <div class="box-content row">
                <div class="col-lg-7 col-md-12">
                   <iframe src="" height="500px" width="500px" name="php"></iframe>
                </div>
